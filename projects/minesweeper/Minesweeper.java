        ...
        do {
            ...
            if (wholeMove.length != 3) {
                ...
                System.out.println(Color.RED + Color.BOLD
                        + "INVALID INPUT: Please enter row, column, and action (uc, f, or uf)" + Color.RESET + "\n");
                continue;
            }
            ...
            try {
                ...
                System.out.println();
                System.out.println(
                        Color.RED + Color.BOLD + "INVALID INPUT: Row and column must be integers" + Color.RESET + "\n");
                continue;
            }
            ...
            if (c1 < 0 || c1 >= board.length || c2 < 0 || c2 >= board[0].length) {
                System.out.println();
                System.out.println(Color.RED + Color.BOLD
                        + "INVALID INPUT: Row and column must be within the board's bounds" + Color.RESET + "\n");
                continue;
            }
            ...
            if (move.equals("uc")) {
                ...
                if (!board[c1][c2].getIsCovered()) {
                    System.out.println();
                    System.out.println(Color.RED + Color.BOLD + "The coordinate is not covered" + Color.RESET);
                    System.out.println();
                    continue;
                }
                if (board[c1][c2].getHasFlag()) {
                ...
                if (!board[c1][c2].getHasFlag()) {
                    System.out.println();
                    System.out.println(
                            Color.RED + Color.BOLD + "Coordinates do not have a flag to uncover" + Color.RESET);
                    System.out.println();
                    continue;
                } else {
                    board[c1][c2].setHasFlag(false);
                ...
                System.out.println();
                System.out.println(Color.RED + Color.BOLD + "INVALID INPUT: Action must be 'uc', 'f', or 'uf'"
                        + Color.RESET + "\n");
            }
        } while (!gameOver());
